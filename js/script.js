(function ($) {
  ...
  if ($(".mobile-menu").length) {
    ...
    $(".mobile-header .nav-outer,.mobile-sticky-header .nav-outer").append(
    ...
    $(".mobile-menu .close-btn, .mobile-menu-back-drop").on(
      "click",
      function () {
    ...
    if ($(".main-header li.dropdown ul").length) {
      $(".main-header .navigation li.dropdown").append(
        '<div class="dropdown-btn"><span class="flaticon-arrow-right"></span></div>'
      );
    }
    ...
    //Mega Menu toggle
    $(".main-menu .navigation > li.has-mega-menu").on(
      "mouseenter",
      function () {
  ...
  $(".portfolio-block,.portfolio-block-three, .portfolio-block-four").each(
    function (i, elem) {
  ...
  $(".portfolio-motion-category .category-title .toggle-btn").on(
    "click",
    function () {
      $(this)
        .parents(".category-column")
        .find(".blocks-outer")
        .slideToggle(300);
      $(this)
        .parents(".category-column")
  ...
  if ($(".portfolio-asymetric").length) {
    $(".portfolio-asymetric .parallax-scroll").attr(
      "data-parallax",
      '{"y":-30,"smoothness":50}'
    );
  }
...
if (
  $(".shop-single .image-carousel").length &&
  $(".shop-single .thumbs-carousel").length
) {
...
function sendEmail(e) {
  ...
  emailjs.send("service_6ucauer", "template_mb13879", formData).then(
    function (response) {
